...
import type { Id, Millis, SimEvent, SimEventDraft, TerritorySnapshot, Treaty } from './types';
...
export function isTreatyParty(
  event: Extract<SimEvent, { kind: 'treatyFormed' | 'treatyExpired' }>,
  factionId: Id,
): boolean {
